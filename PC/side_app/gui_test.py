...
class GUI:
    def __init__(self, root):
        ...
        bg_image = Image.open("D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/bg.jpg")  # 替换为背景图片的文件路径
    ...
    def decode_file(self):
        ...
        axis = []
        a=[]
        filename="D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/tcp.txt"
        # 打开文件并读取前三行数据
    ...
    def display_photos_1_2_3(self):
        ...
        for box_str in detect_result:
            box = eval(box_str)
            boxes.append(box)
        image_paths = ["D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/left_pre.jpg", "D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/center_pre.jpg", "D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/right_pre.jpg"]
        ...
        # 在展示区显示照片1
        image1 = Image.open("D:/junior_2/competition/embedded/11095_ponding_detection-master/left_boxed.png")  # 替换为照片1的文件路径
        ...
        # 在展示区显示照片2
        image2 = Image.open("D:/junior_2/competition/embedded/11095_ponding_detection-master/center_boxed.png")  # 替换为照片2的文件路径
        ...
        # 在展示区显示照片3
        image3 = Image.open("D:/junior_2/competition/embedded/11095_ponding_detection-master/right_boxed.png")  # 替换为照片3的文件路径
    ...
    def generate_panorama(self):
        self.clear_display()  # 清空展示区
        # 图片路径列表
        imgs=["D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/left_pre.jpg","D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/center_pre.jpg"]
        stitcher = stitching.Stitcher()
        panorama = stitcher.stitch(imgs)
        cv2.imwrite("cat.png", panorama)

        imgs=["D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/center_pre.jpg","D:/junior_2/competition/embedded/11095_ponding_detection-master/PC/side_app/right_pre.jpg"]
        stitcher = stitching.Stitcher()
        panorama = stitcher.stitch(imgs)
    ...
    def vertical_view(self):
        self.clear_display()  # 清空展示区
        str1=("转换俯视坐标系\n......\n积水图例生成成功! ")
        img=cv2.imread('D:/junior_2/competition/embedded/11095_ponding_detection-master/left_boxed.png')
        ...
        img=cv2.imread('D:/junior_2/competition/embedded/11095_ponding_detection-master/center_boxed.png')
        pts1 = np.float32([[361, 402], [606, 406], [260, 583], [752, 588]])
        matrix=cv2.getPerspectiveTransform(pts1,pts2)
        img2=cv2.warpPerspective(img,matrix,(width,height))
        cv2.imwrite('2.jpg',img2)

        img=cv2.imread('D:/junior_2/competition/embedded/11095_ponding_detection-master/right_boxed.png')
